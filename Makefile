...
drift-start: ## Start drift monitoring (after ~400 closed trades)
	./scripts/btc_ml drift start

drift-stop: ## Stop drift monitoring
	./scripts/btc_ml drift stop

drift-status: ## Status of drift monitoring
	./scripts/btc_ml drift status
