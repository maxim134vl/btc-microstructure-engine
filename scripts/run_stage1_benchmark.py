#!/usr/bin/env python3
"""Run Stage 1 cognitive validation benchmark."""
...
from benchmark.stage1.runner import run_stage1_benchmark, should_auto_run


def main() -> int:
    parser = argparse.ArgumentParser(description="Stage 1 cognitive validation benchmark")
    ...
    if args.auto_check and not should_auto_run():
