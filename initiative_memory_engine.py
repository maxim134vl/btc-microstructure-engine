...
while True:
    ...
    try:
        ...
        volume = pd.read_parquet("volume_clusters.parquet")
            ...
            if inside_zone:
                ...
                if initiative["direction"] == "BUY":
                    ...
                    if delta > 0:
                        ...
                        print(
                            f"ZONE: {initiative['zone_low']} - 
{initiative['zone_high']}"
                        )
                        ...
                        print(
                            f"ZONE LOST: {initiative['zone_low']} - 
{initiative['zone_high']}"
                        )

                if initiative["direction"] == "SELL":
