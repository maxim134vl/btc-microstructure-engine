"""Display classification for runtime components — health scope from manifest."""

from __future__ import annotations

from typing import Literal

from required_runtime_manifest import (
...
# Display-only labels for non-manifest components
