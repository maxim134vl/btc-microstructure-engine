...
BEHAVIOR_COLORS = {
    ...
    "IC_CONTINUATION_WEAKENING": COGNITION_COLORS["instability"],
    "IC_INITIATIVE_DETERIORATION": COGNITION_COLORS["instability"],
    "IC_ROTATIONAL_PRESSURE": COGNITION_COLORS["neutral_rotation"],
}
