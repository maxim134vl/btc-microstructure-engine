...
print("\nCLEAN STOPPING TEST V3 STARTED\n")
...
if not stopping_series.dropna().empty:
...
if not success_series.dropna().empty:
...
if not failed_series.dropna().empty:
