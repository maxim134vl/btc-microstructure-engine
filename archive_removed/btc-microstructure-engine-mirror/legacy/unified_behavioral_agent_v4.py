...
while True:
    ...
    try:
        ...
        if defended_buys >= 2:
            ...
            observations.append(
                "Repeated defended buy initiatives suggest persistent buyer support beneath the auction."
            )

        if defended_sells >= 2:

            observations.append(
                "Repeated defended sell initiatives suggest persistent seller pressure above the auction."
            )
